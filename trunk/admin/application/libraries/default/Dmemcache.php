...
class Dmemcache {
	...
	//缓存key
	public $key_menu = "_menu";                        				//菜单
	public $key_session = "_session";                  				//session  前后独立
	public $key_agent = "_agent";                      				//代理- 前/后
	public $key_host = "_host";                        				//host绑定，前/后
	public $key_agent_setting_agent = "_agent_setting_agent";     	//代理设置_代理id-前/后
	public $key_message = "_message";                  				//信息公告 - 前/后
	public $key_message_type = "_message_type";        				//信息类型-前/后
	public $key_game_type = "_game_type";              				//游戏类型-前/后
	public $key_agent_extend = "_agent_extend";        				//代理推广-前/后
	public $key_money_bank = "_money_bank";            				//转账银行-前/后
	public $key_money_type = "_money_type";            				//资金类型-前/后
	public $key_money_status = "_money_status";        				//资金状态 -前/后
	public $key_user_banktype = "_user_banktype";     	 			//会员银行类别-前/后
	public $key_user_group_agent = "_user_group_agent";     		//会员级别_代理id-前/后
